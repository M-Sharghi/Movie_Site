...
import {get_popular_movie, get_movie_bio, get_movie_credits, get_movie_recommendations} from "../helpers/server";
...
function Movie_Bio(){
    ...
    return (
        <div>
            <Nav />
            <MovieBio data={data} list={bio} image={images} act={acting} crew={production} recommendation={recommendations}/>
            <Footer />
        </div>
    )
}

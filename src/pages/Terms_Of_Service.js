      ...
      <div className="auto">
        <div className="container terms_of_service">
          ...
          <p>
            ...
            <br />
            &bull; modify or copy the materials;
            <br />
            &bull; use the materials for any commercial purpose or for any
            public display;
            <br />
            &bull; attempt to reverse engineer any software contained on Company
            Name's Website;
            <br />
            &bull; remove any copyright or other proprietary notations from the
            materials; or
            <br />
            &bull; transferring the materials to another person or "mirror" the
            materials on any other server.
            <br />
            This will let Company Name to terminate upon violations of any of
          ...
          <h2>3. Disclaimer</h2>
          <p>
            All the materials on Company Name's Website are provided.
            Company Name makes no warranties, may it be expressed or implied,
            therefore negates all other warranties. Furthermore, Company Name
          ...
          <p>
            ...
            materials on Company Name's Website, even if Company Name or an
          ...
          <p>
            The materials appearing on Company Name's Website may include
            technical, typographical, or photographic errors. Company Name will
            not promise that any of the materials in this Website are accurate,
            complete, or current. Company Name may change the materials
            contained on its Website at any time without notice. Company Name
            does not make any commitment to update the materials.
          </p>
          <h2>6. Links</h2>
          <p>
            Company Name has not reviewed all of the sites linked to its Website
            and is not responsible for the contents of any such linked site. The
            presence of any link does not imply endorsement by Company Name of
            the site. The use of any linked website is at the user's own risk.
          </p>
          <h2>7. Site Terms of Use Modifications</h2>
          <p>
            Company Name may revise these Terms of Use for its Website at any

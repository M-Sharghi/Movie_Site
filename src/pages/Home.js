  ...
  return (
    <div>
      ...
      <div className="home">
        ...
        <div>
          <input className="home_input" onChange={(e) => {setInput(e.target.value);}} type="search" placeholder="Search for ..."></input>
          <br />
          <div className="auto home_search">
            {data.slice(0, 8).map((item) => {
              ...
              if (item.media_type === "person") {
                return (
                  <div>
                    <Link className="home_search_input" to={`/people/${item.id}`} key={item.id}>
                ...
                return (
                  <div>
                    <Link className="home_search_input" to={`/movie/${item.id}`} key={item.id}>
                      <img className="home_search_img" src={img_is_null}/>
                      {item.title}
                    </Link>
                  </div>
                ...
                return (
                  <div>
                    <Link className="home_search_input" to={`/tv/${item.id}`} key={item.id}>
                      <img className="home_search_img" src={img_is_null}/>
                      {item.name}
                    </Link>
                  </div>

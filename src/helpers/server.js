...
export async function get_popular_movie(page) {
    let popular_movie=`${base_url}/movie/popular?api_key=${api_key}&page=${page}`;
  ...
  export async function get_now_playing_movie(page) {
    let now_playing_movie=`${base_url}/movie/now_playing?api_key=${api_key}&page=${page}`;
  ...
  export async function get_upcoming_movie(page) {
    let upcoming_movie=`${base_url}/movie/upcoming?api_key=${api_key}&page=${page}`;
  ...
  export async function get_top_rated_movie(page) {
    let top_rated_movie=`${base_url}/movie/top_rated?api_key=${api_key}&page=${page}`;
  ...
  export async function get_latest_movie(page) {
    let latest_movie=`${base_url}/movie/latest?api_key=${api_key}&page=${page}`;
  ...
  export async function get_popular_tv_shows(page) {
    let popular_tv_shows=`${base_url}/tv/popular?api_key=${api_key}&page=${page}`;
  ...
  export async function get_trending_all_day(page) {
    let trending_all_day=`${base_url}/trending/all/day?api_key=${api_key}&page=${page}`;
  ...
  export async function get_person_bio(id) {
    let person_bio=`${base_url}/person/${id}?api_key=${api_key}`;
  ...
  export async function get_movie_bio(id) {
    let movie_bio=`${base_url}/movie/${id}?api_key=${api_key}`;
  ...
  export async function get_tv_shows_credits(id) {
    let tv_shows_credits=`${base_url}/tv/${id}/credits?api_key=${api_key}&sort_by=known_for_department.desc`;
  ...
  export async function get_tv_shows_genre() {
    let tv_shows_genre=`${base_url}/genre/tv/list?api_key=${api_key}`;
  ...
  export async function get_movie_details(id) {
    let movie_details=`${base_url}/movie/${id}?api_key=${api_key}`;
